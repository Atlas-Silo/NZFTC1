...
namespace NZFTC.Pages.Employees
{
    public class EditEmployeeModel : PageModel
    {
        ...
        public EditEmployeeModel(HttpClient httpClient)
        {
        ...
        public async Task<IActionResult> OnGetAsync(int? id)
        {
            ...
            // get user id/session data in here for self edit
            // permissions for read only and edit own data
            if (id == null)
            {
                return NotFound();
            }
            ...
            try
            {
                ...
                // Map EmployeeDto to UpdateEmployeeDto
